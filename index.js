...
function cb(a,b,c,d,e,f){if(!b)throw Error("Invalid event type");var h=p(e)?!!e.capture:!!e,n=db$1(a);n||(a[Xa]=n=new Ua$1(a));c=n.add(b,c,d,h,f);if(c.proxy)return c;d=eb();c.proxy=d;d.src=a;d.listener=c;if(a.addEventListener)oa$1||(e=h),void 0===e&&(e=!1),a.addEventListener(b.toString(),d,e);else if(a.attachEvent)a.attachEvent(fb(b.toString()),d);else if(a.addListener&&a.removeListener)a.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");return c}
...
function cc$1(a,b,c){a.K=1;a.v=dc$1(M$1(b));a.s=c;a.P=!0;ec$1(a,null);}function ec$1(a,b){a.F=Date.now();N$1(a);a.A=M$1(a.v);var c=a.A,d=a.U;Array.isArray(d)||(d=[String(d)]);fc$1(c.i,"t",d);a.C=0;c=a.l.H;a.h=new $b;a.g=gc(a.l,c?b:null,!a.s);0<a.N&&(a.L=new Cb(q$1(a.La,a,a.g),a.N));Eb(a.S,a.g,"readystatechange",a.ib);b=a.H?Ra(a.H):{};a.s?(a.u||(a.u="POST"),b["Content-Type"]="application/x-www-form-urlencoded",a.g.da(a.A,a.u,a.s,b)):(a.u="GET",a.g.da(a.A,a.u,null,b));H$1();Hb(a.j,a.u,a.A,a.m,a.U,a.s);}
k$1.ib=function(a){a=a.target;const b=this.L;b&&3==O$1(a)?b.l():this.La(a);};
k$1.La=function(a){try{if(a==this.g)a:{const r=O$1(this.g);var b=this.g.Ea();const F=this.g.aa();if(!(3>r)&&(3!=r||ya$1||this.g&&(this.h.h||this.g.fa()||hc$1(this.g)))){this.I||4!=r||7==b||(8==b||0>=F?H$1(3):H$1(2));ic$1(this);var c=this.g.aa();this.Y=c;b:if(jc(this)){var d=hc$1(this.g);a="";var e=d.length,f=4==O$1(this.g);if(!this.h.i){if("undefined"===typeof TextDecoder){P$1(this);Q$1(this);var h="";break b}this.h.i=new l.TextDecoder;}for(b=0;b<e;b++)this.h.h=!0,a+=this.h.i.decode(d[b],{stream:f&&b==e-1});d.splice(0,
e);this.h.g+=a;this.C=0;h=this.h.g;}else h=this.g.fa();this.i=200==c;Ib(this.j,this.u,this.A,this.m,this.U,r,c);if(this.i){if(this.Z&&!this.J){b:{if(this.g){var n,u=this.g;if((n=u.g?u.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!pa$1(n)){var m=n;break b}}m=null;}if(c=m)E(this.j,this.m,c,"Initial handshake response via X-HTTP-Initial-Response"),this.J=!0,kc(this,c);else {this.i=!1;this.o=3;I(12);P$1(this);Q$1(this);break a}}this.P?(lc$1(this,r,h),ya$1&&this.i&&3==r&&(Eb(this.S,this.T,"tick",this.hb),
this.T.start())):(E(this.j,this.m,h,null),kc(this,h));4==r&&P$1(this);this.i&&!this.I&&(4==r?mc(this.l,this):(this.i=!1,N$1(this)));}else 400==c&&0<h.indexOf("Unknown SID")?(this.o=3,I(12)):(this.o=0,I(13)),P$1(this),Q$1(this);}}}catch(r){}finally{}};function jc(a){return a.g?"GET"==a.u&&2!=a.K&&a.l.Da:!1}
function lc$1(a,b,c){let d=!0,e;for(;!a.I&&a.C<c.length;)if(e=nc$1(a,c),e==bc$1){4==b&&(a.o=4,I(14),d=!1);E(a.j,a.m,null,"[Incomplete Response]");break}else if(e==ac$1){a.o=4;I(15);E(a.j,a.m,c,"[Invalid Chunk]");d=!1;break}else E(a.j,a.m,e,null),kc(a,e);jc(a)&&e!=bc$1&&e!=ac$1&&(a.h.g="",a.C=0);4!=b||0!=c.length||a.h.h||(a.o=1,I(16),d=!1);a.i=a.i&&d;d?0<c.length&&!a.$&&(a.$=!0,b=a.l,b.g==a&&b.$&&!b.K&&(b.j.info("Great, no buffering proxy detected. Bytes received: "+c.length),oc$1(b),b.K=!0,I(11))):(E(a.j,a.m,c,
"[Invalid Chunked Response]"),P$1(a),Q$1(a));}k$1.hb=function(){if(this.g){var a=O$1(this.g),b=this.g.fa();this.C<b.length&&(ic$1(this),lc$1(this,a,b),this.i&&4!=a&&N$1(this));}};function nc$1(a,b){var c=a.C,d=b.indexOf("\n",c);if(-1==d)return bc$1;c=Number(b.substring(c,d));if(isNaN(c))return ac$1;d+=1;if(d+c>b.length)return bc$1;b=b.substr(d,c);a.C=d+c;return b}k$1.cancel=function(){this.I=!0;P$1(this);};function N$1(a){a.V=Date.now()+a.O;pc$1(a,a.O);}
function pc$1(a,b){if(null!=a.B)throw Error("WatchDog timer not null");a.B=J(q$1(a.gb,a),b);}function ic$1(a){a.B&&(l.clearTimeout(a.B),a.B=null);}k$1.gb=function(){this.B=null;const a=Date.now();0<=a-this.V?(Kb(this.j,this.A),2!=this.K&&(H$1(),I(17)),P$1(this),this.o=2,Q$1(this)):pc$1(this,this.V-a);};function Q$1(a){0==a.l.G||a.I||mc(a.l,a);}function P$1(a){ic$1(a);var b=a.L;b&&"function"==typeof b.na&&b.na();a.L=null;zb(a.T);Fb(a.S);a.g&&(b=a.g,a.g=null,b.abort(),b.na());}
function kc(a,b){try{var c=a.l;if(0!=c.G&&(c.g==a||qc$1(c.h,a)))if(!a.J&&qc$1(c.h,a)&&3==c.G){try{var d=c.Fa.g.parse(b);}catch(m){d=null;}if(Array.isArray(d)&&3==d.length){var e=d;if(0==e[0])a:{if(!c.u){if(c.g)if(c.g.F+3E3<a.F)rc$1(c),sc$1(c);else break a;tc$1(c);I(18);}}else c.Ba=e[1],0<c.Ba-c.T&&37500>e[2]&&c.L&&0==c.A&&!c.v&&(c.v=J(q$1(c.cb,c),6E3));if(1>=uc$1(c.h)&&c.ja){try{c.ja();}catch(m){}c.ja=void 0;}}else R(c,11);}else if((a.J||c.g==a)&&rc$1(c),!pa$1(b))for(e=c.Fa.g.parse(b),b=0;b<e.length;b++){let m=e[b];c.T=
...
Z.g?Z.g.getResponseHeader("X-HTTP-Session-Id"):null;tb&&(d.za=tb,S$1(d.F,d.D,tb));}}c.G=3;c.l&&c.l.xa();c.$&&(c.P=Date.now()-a.F,c.j.info("Handshake RTT: "+c.P+"ms"));d=c;var h=a;d.sa=wc(d,d.H?d.ka:null,d.V);if(h.J){xc$1(d.h,h);var n=h,u=d.J;u&&n.setTimeout(u);n.B&&(ic$1(n),N$1(n));d.g=h;}else yc(d);0<c.i.length&&zc(c);}else "stop"!=m[0]&&"close"!=m[0]||R(c,7);else 3==c.G&&("stop"==m[0]||"close"==m[0]?"stop"==m[0]?R(c,7):Ac$1(c):"noop"!=m[0]&&c.l&&c.l.wa(m),c.A=0);}H$1(4);}catch(m){}}function Bc$1(a){if(a.W&&"function"==typeof a.W)return a.W();if("undefined"!==typeof Map&&a instanceof Map||"undefined"!==typeof Set&&a instanceof Set)return Array.from(a.values());if("string"===typeof a)return a.split("");if(ba(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}b=[];c=0;for(d in a)b[c++]=a[d];return b}
...
function Gc$1(a,b,c){a.j=c?Kc$1(b,!0):b;a.j&&(a.j=a.j.replace(/:$/,""));}function Hc(a,b){if(b){b=Number(b);if(isNaN(b)||0>b)throw Error("Bad port number "+b);a.m=b;}else a.m=null;}function Jc(a,b,c){b instanceof Ic$1?(a.i=b,Qc(a.i,a.h)):(c||(b=Lc$1(b,Rc$1)),a.i=new Ic$1(b,a.h));}function S$1(a,b,c){a.i.set(b,c);}function dc$1(a){S$1(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36));return a}
function Kc$1(a,b){return a?b?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Lc$1(a,b,c){return "string"===typeof a?(a=encodeURI(a).replace(b,Sc$1),c&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Sc$1(a){a=a.charCodeAt(0);return "%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Mc$1=/[#\/\?@]/g,Oc$1=/[#\?:]/g,Nc$1=/[#\?]/g,Rc$1=/[#\?@]/g,Pc$1=/#/g;function Ic$1(a,b){this.h=this.g=null;this.i=a||null;this.j=!!b;}
...
"success");else {a.m=6;try{var h=2<O$1(a)?a.g.statusText:"";}catch(u){h="";}a.j=h+" ["+a.aa()+"]";rd(a);}}finally{sd(a);}}}function sd(a,b){if(a.g){pd(a);const c=a.g,d=a.C[0]?aa$1:null;a.g=null;a.C=null;b||C$1(a,"ready");try{c.onreadystatechange=d;}catch(e){}}}function pd(a){a.g&&a.K&&(a.g.ontimeout=null);a.A&&(l.clearTimeout(a.A),a.A=null);}function O$1(a){return a.g?a.g.readyState:0}k$1.aa=function(){try{return 2<O$1(this)?this.g.status:-1}catch(a){return -1}};
...
function Ac$1(a){yd(a);if(3==a.G){var b=a.U++,c=M$1(a.F);S$1(c,"SID",a.I);S$1(c,"RID",b);S$1(c,"TYPE","terminate");zd(a,c);b=new L$1(a,a.j,b,void 0);b.K=2;b.v=dc$1(M$1(c));c=!1;l.navigator&&l.navigator.sendBeacon&&(c=l.navigator.sendBeacon(b.v.toString(),""));!c&&l.Image&&((new Image).src=b.v,c=!0);c||(b.g=gc(b.l,null),b.g.da(b.v));b.F=Date.now();N$1(b);}Ad(a);}function sc$1(a){a.g&&(oc$1(a),a.g.cancel(),a.g=null);}
function yd(a){sc$1(a);a.u&&(l.clearTimeout(a.u),a.u=null);rc$1(a);a.h.cancel();a.m&&("number"===typeof a.m&&l.clearTimeout(a.m),a.m=null);}function zc(a){Yc(a.h)||a.m||(a.m=!0,sb(a.Ja,a),a.C=0);}function Bd(a,b){if(uc$1(a.h)>=a.h.j-(a.m?1:0))return !1;if(a.m)return a.i=b.D.concat(a.i),!0;if(1==a.G||2==a.G||a.C>=(a.Za?0:a.$a))return !1;a.m=J(q$1(a.Ja,a,b),Cd(a,a.C));a.C++;return !0}
k$1.Ja=function(a){if(this.m)if(this.m=null,1==this.G){if(!a){this.U=Math.floor(1E5*Math.random());a=this.U++;const e=new L$1(this,this.j,a,void 0);let f=this.s;this.S&&(f?(f=Ra(f),Ta$1(f,this.S)):f=this.S);null!==this.o||this.N||(e.H=f,f=null);if(this.O)a:{var b=0;for(var c=0;c<this.i.length;c++){b:{var d=this.i[c];if("__data__"in d.g&&(d=d.g.__data__,"string"===typeof d)){d=d.length;break b}d=void 0;}if(void 0===d)break;b+=d;if(4096<b){b=c;break a}if(4096===b||c===this.i.length-1){b=c+1;break a}}b=1E3;}else b=
...
function mc(a,b){var c=null;if(a.g==b){rc$1(a);oc$1(a);a.g=null;var d=2;}else if(qc$1(a.h,b))c=b.D,xc$1(a.h,b),d=1;else return;if(0!=a.G)if(a.pa=b.Y,b.i)if(1==d){c=b.s?b.s.length:0;b=Date.now()-b.F;var e=a.C;d=Mb();C$1(d,new Pb(d,c));zc(a);}else yc(a);else if(e=b.o,3==e||0==e&&0<a.pa||!(1==d&&Bd(a,b)||2==d&&tc$1(a)))switch(c&&0<c.length&&(b=a.h,b.i=b.i.concat(c)),e){case 1:R(a,5);break;case 4:R(a,10);break;case 3:R(a,6);break;default:R(a,2);}}
...
function Ad(a){a.G=0;a.la=[];if(a.l){const b=Zc(a.h);if(0!=b.length||0!=a.i.length)na(a.la,b),na(a.la,a.i),a.h.i.length=0,ma$1(a.i),a.i.length=0;a.l.ua();}}function wc(a,b,c){var d=c instanceof T?M$1(c):new T(c,void 0);if(""!=d.g)b&&(d.g=b+"."+d.g),Hc(d,d.m);else {var e=l.location;d=e.protocol;b=b?b+"."+e.hostname:e.hostname;e=+e.port;var f=new T(null,void 0);d&&Gc$1(f,d);b&&(f.g=b);e&&Hc(f,e);c&&(f.l=c);d=f;}c=a.D;b=a.za;c&&b&&S$1(d,c,b);S$1(d,"VER",a.ma);zd(a,d);return d}
function gc(a,b,c){if(b&&!a.H)throw Error("Can't create secondary domain capable XhrIo object.");b=c&&a.Da&&!a.ra?new W$1(new ed({jb:!0})):new W$1(a.ra);b.Ka(a.H);return b}function Gd(){}k$1=Gd.prototype;k$1.xa=function(){};k$1.wa=function(){};k$1.va=function(){};k$1.ua=function(){};k$1.Ra=function(){};function Hd(){if(y&&!(10<=Number(La)))throw Error("Environmental error: no available transport.");}Hd.prototype.g=function(a,b){return new X$1(a,b)};
 ...
 */ class Bo {
     ...
     */    Oi(t, e, n, s) {
        return fn(e) || s.isEqual(st.min()) ? this.Mi(t, e) : this.Ni.getDocuments(t, n).next((i => {
            const r = this.Fi(e, i);
            return this.$i(e, r, n, s) ? this.Mi(t, e) : (S() <= LogLevel.DEBUG && C("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), En(e)), 
    ...
    Mi(t, e) {
        return S() <= LogLevel.DEBUG && C("QueryEngine", "Using full collection scan to execute query:", En(e)), 
 ...
 */ !function(t, e = !0) {
    ...
    }), "PUBLIC").setMultipleInstances(!0)), registerVersion(b, "3.8.3", t), 
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
...
async function getScores() {
    ...
    const querySnapshot = await Bl(
      sl(dbRef, hl("score", "desc"))
    );
